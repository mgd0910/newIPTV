    ...
    <div class="parenting">
        ...
        <div class="body">
            ...
            <div class="recommendBox">
                ...
                >   
                    <img src="../../static/images/jbcz.jpg" alt="" v-if="i==5">
                    <img :src="v.image" alt="" v-else>
                </div>
            </div>
        </div>
        <Foot 
...
export default {
    ...
    methods: {
        getData(){
            let data=["disease-head-list","disease-lower-list","disease-column-list","disease-special"];
            server.geData(data).then(ret=>{
                this.projectList=ret['disease-head-list'].content;
                this.videoList=ret['disease-lower-list'].content;
                this.recommendList=ret['disease-column-list'].content;
                this.recommendList.push(this.recommendLast)
                this.footList = ret['disease-special']
        ...
        projectup(i){
            let el = document.getElementsByClassName("navBoxListTit")[3];
        ...
        recommendClk(i,v){
            ...
            if(i==5){
                storage.set("diseaseHistoryPath",{
                    path:this.$route.path
                })
                this.$router.push({
                    path: "/screening"
